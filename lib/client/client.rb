  ...
  class Client
    ...
    def perform
      ...
      when 'Расписание и запись', '/schedule'
        ...
        send_schedule
        send_message(chat_id: @chat_id, text: 'Обратите внимание, что у меня изменились цены на массаж. Обновленные цены можно узнать по команде /costtime')
    ...
    def about_cost
      [
        ...
        "90 минут — 6000",
        "2 часа — 8000",
        "3 часа — 11000, для длинных сеансов я делаю цену ниже, потому что мне они очень нравятся.\n",
        ...
        "Абонемент на 6 часов, который можно произвольно делить на сеансы, он стоит 21 000.",
        "Абонемент действует 6 месяцев начиная с первого сеанса.\n",
        "Ну и конечно работает моя бессрочная акция «Я — мама», 90 минут массажа — 4000"
      ].join("\n")
    end
