  ...
  class Client
    ...
    def about_cost
      [
        ...
        "90 минут — 5400",
        "2 часа — 7000",
        "3 часа — 9500, для длинных сеансов я делаю цену ниже, потому что мне они очень нравятся.\n",
        ...
        "2. Если по вашей рекомендации пришел друг, он\а получает скидку 10% на свой первый сеанс, и вы тоже получаете 10%"
      ].join("\n")
    end
